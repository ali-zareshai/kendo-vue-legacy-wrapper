 ...
 *-------------------------------------------------------------------------------------------
 */
import { getAllShortIds as p, isIdZeroLevel as h, getRootParentId as I, getIdWithoutRootParentId as b, createId as g, EMPTY_ID as C } from "./itemIdUtils.mjs";
import x from "./SortedPublicItemIds.mjs";
...
function d(t, o, e, n, u) {
  ...
  if (r >= t.length)
    return t;
  let s = t, c = t[r];
  return c[n] || (s = t.slice(), c = s[r] = Object.assign({}, c, { [n]: !0 })), h(o) ? e(c) : c[u] && (c[u] = d(
    c[u],
    b(o),
    e,
    n,
...
function w(t, o, e, n, u) {
  return (t[n] || []).every((s, c) => u.indexOf(e ? i(e, s) : g(c, o)) > -1);
}
function y(t, o, e) {
  const n = [], u = p(t);
  let r = e;
