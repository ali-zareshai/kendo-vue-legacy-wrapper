...
const v = "https://www.telerik.com/kendo-vue-ui/components/my-license/?utm_medium=product&utm_source=kendovue&utm_campaign=kendo-ui-vue-purchase-license-keys-banner";
let r = [];
const f = /* @__PURE__ */ t({
  ...
  mounted() {
    if (this.bannerWrapper = this.$refs.banner, r.push(this.bannerWrapper), document && document.body && document.body.append(this.bannerWrapper), r.length > 1)
      for (let n = 1; n < r.length; n++)
        r[n].remove();
  },
  beforeUnmount() {
    this.bannerWrapper.remove(), r = [];
  },
  data() {
    return {
      watermarkStyles: {
  ...
  render() {
    const {
      message: n
    } = this.$props, A = this.showBanner && e("div", {
      ...
      innerHTML: n
    }, null) : e("span", null, [o("We couldn't verify your "), e("a", {
      href: v
    }, [o("license key")]), o(" for Kendo UI for Vue. Please see the browser console for details and resolution steps.")]), e("div", {
      style: {
        display: "flex",
        alignItems: "center",
        marginLeft: "24px"
